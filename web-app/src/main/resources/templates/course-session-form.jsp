...
<div class="container">
    <div class="col-md-offset-2 col-md-7">
        <h3 class="text-center">Create a courseDto session</h3>
...
<%--                    <form:select path="courseDto">--%>
<%--                        <form:option value="NONE"> --SELECT--</form:option>--%>
<%--                        <form:options modelAttribute="courses" items="${courses}" itemValue="id" itemLabel="title"></form:options>--%>
<%--                    </form:select>--%>

                    <div class="form-group">
                        <label for="courseSession.courseDto" class="col-md-3 control-label">Course</label>
                        <div class="col-md-9">
                        <c:if test="${fn:length(courseSessionModel.courses) gt 0}">
                            <form:select path="courseSession.courseDto" items="${courseSessionModel.courses}" itemLabel="title" itemValue="id"/>
                        </c:if>
                    ...
                    <div class="form-group">
                        <label for="courseSession.locationDto" class="col-md-3 control-label">Location</label>
                        <div class="col-md-9">
                            <c:if test="${fn:length(courseSessionModel.locations) gt 0}">
                                <form:select path="courseSession.locationDto" items="${courseSessionModel.locations}" itemLabel="city" itemValue="id"/>
                            </c:if>
