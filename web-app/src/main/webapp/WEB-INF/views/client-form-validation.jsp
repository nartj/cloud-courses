...
<%@ taglib prefix="redirect" uri="http://www.springframework.org/tags/form" %>
    ...
    <div class="col-md-offset-2 col-md-7">
        ...
        <div class="panel panel-info">
            <div class="panel-body">
                <h5>${client.firstName}, your have been successfully registered.</h5>
                <label class="col-md-10 control-label">View your registration information below.</label>
            </div>
            <div class="panel-body">
                <form action="${pageContext.request.contextPath}/course/list">
                    <button class="btn btn-info">Back</button>
                </form>
            </div>
        </div>
        <hr />
        <form:form class="form-horizontal" modelAttribute="courseSession">
        <div class="panel panel-info">
            <div class="panel-body">
                <div class="form-group">
                    <label for="startDate" class="col-md-3 control-label">Start Date</label>
                    <div class="col-md-9">
                        <form:input path="startDate" type="text" id="datepicker-start" class="form-control"
                                    placefolder="${courseSession.startDate}" disabled="true" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="endDate" class="col-md-3 control-label">End Date</label>
                    <div class="col-md-9">
                        <form:input path="endDate" type="text" id="datepicker-end" class="form-control"
                                    placefolder="${courseSession.endDate}" disabled="true" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="course.title" class="col-md-3 control-label">Course</label>
                    <div class="col-md-9">
                        <form:input path="course.title" class="form-control"
                                    placefolder="${courseSession.course.title}" disabled="true" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="location.city" class="col-md-3 control-label">Location</label>
                    <div class="col-md-9">
                        <form:input path="location.city" class="form-control"
                                    placefolder="${courseSession.location.city}" disabled="true" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <hr />
        <form:form class="form-horizontal" modelAttribute="client">
            <div class="panel panel-info">
                <div class="panel-body">
                    <form:hidden path="id" />
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <form:input path="firstName" class="form-control"
                                        placefolder="${client.firstName}" disabled="true" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <form:input path="lastName" class="form-control"
                                        placefolder="${client.lastName}" disabled="true" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <form:input path="email" class="form-control"
                                        placefolder="${client.email}" disabled="true" />
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <form:input path="address" class="form-control"
                                        placefolder="${client.address}" disabled="true" />
                        </div>
                    </div>
                    </div>
                </div>
