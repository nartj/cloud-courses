            ...
            <div class="panel-body">
                <table class="table table-striped table-bordered">
                    ...
                    <c:forEach var="tempClient" items="${clients}">
                        ...
                        <c:url var="updateLink" value="/clientDto/update" >
                            <c:param name="id" value="${tempClient.id}" />
                        </c:url>

                        <!-- construct an "delete" link with clientDto id -->
                        <c:url var="deleteLink" value="/clientDto/delete">
                            <c:param name="id" value="${tempClient.id}" />
                        </c:url>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                | <a href="${deleteLink}"
                                     onclick="if (!(confirm('Are you sure you want to delete this clientDto?'))) return false">Delete</a>
                            </td>
